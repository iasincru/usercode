...
{    
    ...
    if (systematic_ == "JER_UP" || systematic_ == "JER_DOWN" ||
        systematic_ == "JER_DOWN_M1SIGMA"  || systematic_ == "JER_UP_P1SIGMA" ||
        systematic_ == "JER_DOWN_M15SIGMA" || systematic_ == "JER_UP_P15SIGMA" ||
        systematic_ == "JER_DOWN_M2SIGMA"  || systematic_ == "JER_UP_P2SIGMA") {
        doJesJer_ = true;
    }
}
                                       ...
                                       const VLV* associatedGenJet, const VLV* associatedGenJetForMET)const
{
    ...
    double nom[5] = {1.052, 1.057, 1.096, 1.134, 1.288};
    if(systematic_ == "JER_UP_P1SIGMA"){
        ResolutionEtaScaleFactor[0] = nom[0] + 1. * std::abs(1.115-nom[0]);
        ResolutionEtaScaleFactor[1] = nom[1] + 1. * std::abs(1.114-nom[1]);
        ResolutionEtaScaleFactor[2] = nom[2] + 1. * std::abs(1.161-nom[2]);
        ResolutionEtaScaleFactor[3] = nom[3] + 1. * std::abs(1.228-nom[3]);
        ResolutionEtaScaleFactor[4] = nom[4] + 1. * std::abs(1.488-nom[4]);
    }
    else if(systematic_ == "JER_UP_P15SIGMA"){
        ResolutionEtaScaleFactor[0] = nom[0] + 1.5 * std::abs(1.115-nom[0]);
        ResolutionEtaScaleFactor[1] = nom[1] + 1.5 * std::abs(1.114-nom[1]);
        ResolutionEtaScaleFactor[2] = nom[2] + 1.5 * std::abs(1.161-nom[2]);
        ResolutionEtaScaleFactor[3] = nom[3] + 1.5 * std::abs(1.228-nom[3]);
        ResolutionEtaScaleFactor[4] = nom[4] + 1.5 * std::abs(1.488-nom[4]);
    }
    else if(systematic_ == "JER_UP_P2SIGMA"){
        ResolutionEtaScaleFactor[0] = nom[0] + 2. * std::abs(1.115-nom[0]);
        ResolutionEtaScaleFactor[1] = nom[1] + 2. * std::abs(1.114-nom[1]);
        ResolutionEtaScaleFactor[2] = nom[2] + 2. * std::abs(1.161-nom[2]);
        ResolutionEtaScaleFactor[3] = nom[3] + 2. * std::abs(1.228-nom[3]);
        ResolutionEtaScaleFactor[4] = nom[4] + 2. * std::abs(1.488-nom[4]);
    }
    else if(systematic_ == "JER_DOWN_M1SIGMA"){
        ResolutionEtaScaleFactor[0] = nom[0] - 1. * std::abs(0.990-nom[0]);
        ResolutionEtaScaleFactor[1] = nom[1] - 1. * std::abs(1.001-nom[1]);
        ResolutionEtaScaleFactor[2] = nom[2] - 1. * std::abs(1.032-nom[2]);
        ResolutionEtaScaleFactor[3] = nom[3] - 1. * std::abs(1.042-nom[3]);
        ResolutionEtaScaleFactor[4] = nom[4] - 1. * std::abs(1.089-nom[4]);
    }
    else if(systematic_ == "JER_DOWN_M15SIGMA"){
        ResolutionEtaScaleFactor[0] = nom[0] - 1.5 * std::abs(0.990-nom[0]);
        ResolutionEtaScaleFactor[1] = nom[1] - 1.5 * std::abs(1.001-nom[1]);
        ResolutionEtaScaleFactor[2] = nom[2] - 1.5 * std::abs(1.032-nom[2]);
        ResolutionEtaScaleFactor[3] = nom[3] - 1.5 * std::abs(1.042-nom[3]);
        ResolutionEtaScaleFactor[4] = nom[4] - 1.5 * std::abs(1.089-nom[4]);
    }
    else if(systematic_ == "JER_DOWN_M2SIGMA"){
        ResolutionEtaScaleFactor[0] = nom[0] - 2. * std::abs(0.990-nom[0]);
        ResolutionEtaScaleFactor[1] = nom[1] - 2. * std::abs(1.001-nom[1]);
        ResolutionEtaScaleFactor[2] = nom[2] - 2. * std::abs(1.032-nom[2]);
        ResolutionEtaScaleFactor[3] = nom[3] - 2. * std::abs(1.042-nom[3]);
        ResolutionEtaScaleFactor[4] = nom[4] - 2. * std::abs(1.089-nom[4]);
    }
/*    
    ...
    for(size_t i = 0; i < jets->size(); ++i){
        ...
        if(jetJERSF_->at(i) != 0.){
            ...
            jets->at(i) *= factor;
//             if(i==0)std::cout<<"SF: "<<ResolutionEtaScaleFactor[jetEtaBin]<<std::endl;
        }
    }
